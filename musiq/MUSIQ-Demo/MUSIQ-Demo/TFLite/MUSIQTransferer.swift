...
class MUSIQTransferer {
  ...
  static func newCPUMUSIQTransferer(
    ...
    return MUSIQTransferer.newInstance(transferModel: Constants.Int8.transferModel,
  ...
  static func newGPUMUSIQTransferer(
    ...
    return MUSIQTransferer.newInstance(transferModel: Constants.Float16.transferModel,
